...
===============================
To display administrative calendars, Rooms depends on the FullCalendar (http://fullcalendar.io) library. Within the Rooms module there is a rooms.make file which will download the library if using Drush or you can visit `here <https://github.com/arshaw/fullcalendar/releases/download/v3.1.0/fullcalendar-3.1.0.zip>`_ to download it.
